...
func main() {
	...
	v1 := r.Group("/v1")
	{
		...
		category := v1.Group("/categories")
		{
			...
			category.GET("", categoryHandlerV1.GetCategoryV1)
			category.GET("/:category", categoryHandlerV1.GetCategoryByIdV1)
			category.POST("", categoryHandlerV1.PostCategoryV1)
			category.PUT("/:category", categoryHandlerV1.PutCategoryV1ById)
			category.DELETE("/:category", categoryHandlerV1.DeleteCategoryV1ById)
		}
